...
//  FILE:         switchminaboutdlg.cpp
//  AUTHOR:       Pat B. Double
//
//  OVERVIEW
//  ~~~~~~~~
//  Source file for implementation of TSwitchMinAboutDlg (TDialog).
//
//----------------------------------------------------------------------------
...
//{{TSwitchMinAboutDlg Implementation}}
...
//
TSwitchMinAboutDlg::TSwitchMinAboutDlg(TWindow* parent, TResId resId, TModule* module)
:
...
TSwitchMinAboutDlg::~TSwitchMinAboutDlg()
{
  Destroy();
...
void TSwitchMinAboutDlg::SetupWindow()
{
